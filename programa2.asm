...
;a) O PIC deverá enviar uma única vez o valor 123 para o PC, via serial
;b) O PIC deverá fica esperando a chegada de algum byte qualquer pela serial. 
;c) Quando o byte chegar o PIC deverá somar um ao mesmo e então enviar o valor somado para o PC
...
WAIT:
	...
	GOTO WAIT        ; NÃO CHEGOU
;PASSO C
	MOVWF RCREG,W    ; SIM  ENTÃO: W = RCREG GUARDADO O DADO Q CHEGOU EM W
